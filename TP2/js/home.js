...
Promise.all([loadTemplates(), loadHome(), loadGamesData()])
  .then(([_, __, gamesData]) => {
    ...
    document.getElementById("carouseles-container-1").prepend(featuredCarousel);
    ...
    document.getElementById("popular-carousele").appendChild(popularesCarousel);
    ...
    document.getElementById("new-carousele").appendChild(newCarousel);
    ...
    document.getElementById("adventure-carousele").appendChild(adventureCarousel);
    ...
    document.getElementById("action-carousele").appendChild(actionCarousel);
    ...
    //   quantity: 32
    // });
    // document.getElementById("shooter-carousele").appendChild(shooterCarousel);
  });
